...
export const BeginnerView: React.FC<LessonViewProps> = ({
  ...
  const isStep3Done = checkedState.every(Boolean); // All 3 questions must be checked
    ...
    <div className="relative z-10 max-w-4xl mx-auto px-4 py-8">
      ...
      >
        <div className="flex justify-between items-center gap-4">
          <div>
            <span className="text-xs font-black uppercase text-indigo-400 tracking-widest">Beginner Lesson {lesson.id}</span>
