...
export const IntermediateView: React.FC<LessonViewProps> = ({
  lesson,
  onComplete,
  onBack,
}) => {
    ...
    <div className="relative z-10 max-w-4xl mx-auto px-4 py-8">
      ...
      >
        <div className="flex justify-between items-center gap-4">
          <div>
            <span className="text-xs font-black uppercase text-indigo-400 tracking-widest">Intermediate Lesson {lesson.id}</span>
